 ...
 * Replace FEAT-EDISHIPMENTREPORTIMPORT with your feature ID and adjust settings as needed.
 *
 * Usage:
 *   1. Copy to specs/<feature>/tests/e2e/playwright.config.ts
 *   2. Replace placeholders (FEAT-EDISHIPMENTREPORTIMPORT, baseURL, etc.)
