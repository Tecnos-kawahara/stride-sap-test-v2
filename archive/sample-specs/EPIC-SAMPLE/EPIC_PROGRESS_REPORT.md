...
|---------|-----------|------|--------|-----------------------|----------|---------|
| TEAM-SALES | 営業システムチーム | 鈴木次郎 | on_track | 0/1 | 0 | WI-001完了。WI-002設計レビュー準備中 |
...
|------------|------|------|--------|--------|--------|--------|--------|-------|-------|
| FEAT-ERP-OMS | TEAM-SALES | standard | approved | approved | approved | approved | approved | in_progress | Execute |
...
|-----------|-------------|--------|------------|----------|-------|
| EM-01: 受注登録基盤 | 2026-02-10 | completed | 100% | FEAT-ERP-OMS | WI-001完了 |
| EM-02: 権限・承認 | 2026-03-01 | on_track | 0% | FEAT-ERP-OMS | WI-002待ち |
| EM-03: リリース | 2026-03-15 | pending | 0% | FEAT-ERP-OMS | EM-02完了後 |
...
|--------|------|----|------|--------|----------|----------|-----------|--------|
| DEP-001 | FEAT-ERP-OMS | mcframe-core | blocking | adopted | PLATFORM | TEAM-SALES | 2026-02-01 | 2026-02-01 |
...
|---------|-------------|------|--------|--------|------------|-------|-----------|
| ER-001 | mcframe API月次締め応答遅延 | High | Medium | mitigating | リトライ+PENDING_STOCK | TEAM-SALES | No |
| ER-002 | 権限チェック複雑さ→セキュリティ | Medium | High | open | authz_matrix.yaml+validate mode | TEAM-SALES | No |
| ER-003 | 監査ログ欠落→コンプライアンス | Low | High | open | TS-INT-04全パターン検証 | TEAM-SALES | No |
...
|-------------|------|-------------|-----------|----------------|
| RPT-DR-001 | 2026-02-10 | ConfirmDialogを共通コンポーネント化 | 他画面でも再利用可能 | TEAM-SALES |
...
|-----------|-------------|-------|----------|----------|-----------------|
| ACT-001 | WI-002 Pre-Run設計レビュー実施 | 鈴木次郎 | 2026-02-20 | high | FEAT-ERP-OMS |
| ACT-002 | 監査ログ保存期間の最終決定 | 田中太郎 | 2026-02-28 | medium | FEAT-ERP-OMS |
