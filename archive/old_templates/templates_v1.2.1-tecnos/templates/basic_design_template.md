...
> v1.2.1: E2Eタグ対象フローの明示とCoverage Policyの方針決定を含む。
...
basic_design:
  ...
  integration_flows:
    - id: "FLOW-001"
      ...
      e2e_target: true  # v1.2.1: E2Eスモーク回帰の対象にするか
...
### B.5.1 E2E Testing Policy（v1.2.1）
- **二重ループ設計**:
...
- [ ] **E2Eタグ付きACは「重要ユーザージャーニー」に限定されている**（v1.2.1）
- [ ] **Coverage Policyの方針が決定されている**（v1.2.1）
