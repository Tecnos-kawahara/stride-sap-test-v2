# Quick Start Guide: templates_v1.2.1-tecnos
...
version: "1.2.1-tecnos"          # テンプレートバージョン
...
```bash
cp templates_v1.2.1-tecnos/templates/basic_design_template.md specs/my_first_feature/basic_design.md
cp templates_v1.2.1-tecnos/templates/spec_template.md specs/my_first_feature/spec.md
cp templates_v1.2.1-tecnos/templates/plan_template.md specs/my_first_feature/plan.md
cp templates_v1.2.1-tecnos/templates/tasks_template.md specs/my_first_feature/tasks.md
```
