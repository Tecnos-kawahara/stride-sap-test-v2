...
> v1.2.2: Coverage Policy（AC/CT/Code）、E2E Tooling/Reporting、AgentOps Loop を定義。
...
plan:
  ...
  test_strategy:
    ...
    # v1.2.2: E2E Tooling（Playwright MCP / Test）
    tooling:
    ...
    tests:
      - id: "TS-CON-01"
        ...
        covers_contract_ids: ["CT-API-01"]              # v1.2.2: CT→TSの紐付け
