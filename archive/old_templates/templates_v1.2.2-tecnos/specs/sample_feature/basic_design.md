...
title: "Basic Design - Sample Feature"
...
basic_design:
  ...
  context:
    ...
    what: "Sample integration flow validation"
    why: "Demonstrate template linting"
  ...
  integration_flows:
    - id: "FLOW-001"
      ...
      summary: "Sync order data from CRM to ERP"
      kpi_slo: "P95 < 3s"
  ...
  traceability_rows:
    - rq:
        ...
        statement: ""
      us:
        id: "US-FEAT001-001"     # 未確定なら "" でも可
        title: "Submit order sync request"
      ac:
        id: "AC-US-FEAT001-001-01"  # 未確定なら "" でも可
        statement: "Integration path completes successfully"
        tags: ["integration"]
      bpmn:
