...
- **v1.2.2**: Coverage Policy（AC/CT/Code）に基づくテスト網羅性を機械検証し、AIエージェント（バイブコーディング）でも品質を担保する。
...
## 6.2 spec_gate_check.counts（Tecnos拡張 + v1.2.2）
...
- `speckit-lint --coverage-report` (v1.2.2: AC/CT/Code coverage summary)
