...
AC Coverage:
  - Add @ac:AC-US-FEATXXX-001-01 in docstring to link to ACs
...
# =============================================================================
# Test Class: FEAT-XXX - <Feature Name>
# =============================================================================

class TestFeatureXXX:
    """E2E tests for FEAT-XXX: <Feature Name>
    ...
    def test_e2e_03_protected_route_requires_auth(self, page: Page) -> None:
        ...
        @ac AC-US-FEATXXX-001-03 - <AC Statement>
    ...
    def test_e2e_04_example_with_authenticated_user(
        ...
        @ac AC-US-FEATXXX-002-01 - <AC Statement>
...
class TestCompleteWorkflow:
    ...
    def test_complete_order_workflow(self, page: Page) -> None:
        ...
        @ac AC-US-FEATXXX-010-01 - Complete workflow
...
class TestErrorScenarios:
    ...
    def test_invalid_login_shows_error(self, page: Page) -> None:
        ...
        @ac AC-US-FEATXXX-020-01 - Error handling
        """
        page.goto("/login")
    ...
    def test_form_validation_errors(self, page: Page) -> None:
        ...
        @ac AC-US-FEATXXX-020-02 - Validation
        """
        page.goto("/register")
