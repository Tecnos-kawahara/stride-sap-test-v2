...
plan:
  ...
  test_strategy:
    ...
    # v1.2.4: Multi-language Test Runners 追加
    tooling:
      ...
      language_runners:
        typescript:
          ...
          dom_testing: "@testing-library/react"  # フロントエンド用（任意）
          coverage_targets:
            line_pct: 80
            branch_pct: 70
        python:
        ...
        go:
          ...
          mock_framework: "gomock"  # or "testify"
          lint: "golangci-lint"
      ...
      cross_language_contracts:
        ...
        tools:
          - type: "openapi"
            ...
            validation: "schemathesis"  # or "dredd"
          - type: "pact"
            contracts_dir: "contracts/pacts/"
            broker_url: ""  # Pact Broker URL（任意）
