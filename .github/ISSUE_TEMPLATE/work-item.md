...
risk_flags: []              # authz, sod, audit_log, pii, db_schema, data_migration,
                            # update_integration, cross_module, accounting_calc,
                            # inventory_valuation, new_api, contract_change,
                            # performance_sensitive, ui_only, message_only, test_only, logging_only
spec_refs:
  - "basic_design.md"
  - "spec.md"
  - "plan.md"
